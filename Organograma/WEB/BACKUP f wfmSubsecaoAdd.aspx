...
<%@ Page Title="" Language="C#" MasterPageFile="~/gsOrgMaster.Master" AutoEventWireup="true" CodeBehind="BACKUP f wfmSubsecaoAdd.aspx.cs" Inherits="WEB.wfmSubsecaoAdd______" %>
...
<dx:SplitterContentControl ID="SplitterContentControl2" runat="server" SupportsDisabledAttribute="True"><br />
   ...
   <td style="text-align:center">
       <dx:ASPxButton ID="btnRemover" runat="server" EnableDefaultAppearance="False"  Cursor="hand"
           ToolTip="Adicionar" OnClick="btnRemover_Click">

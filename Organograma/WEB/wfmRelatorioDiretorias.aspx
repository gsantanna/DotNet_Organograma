<%@ Page Title="" Language="C#" MasterPageFile="~/gsOrgRelatorios.master" AutoEventWireup="true" CodeBehind="wfmRelatorioDiretorias.aspx.cs" Inherits="WEB.wfmRelatorioDiretorias" %>
...
<asp:View ID="vFiltro" runat="server" >
 <!-- Filtro -->
    ...
    <td><uc1:FiltroRelatoriosSecao ID="filtroMain" runat="server" 
            IncluirDiretorias="True" IncluirSecoes="False" /></td>
    </tr>
...
<dx:ASPxGridView ID="dGridResposta" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="Seção" FieldName="Secao" 
            VisibleIndex="1">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="Seção Superior" VisibleIndex="2"  
        ...
        <dx:GridViewDataTextColumn FieldName="Funcionarios_Linha" VisibleIndex="7" 

<%@ Page Title="" Language="C#" MasterPageFile="~/gsOrgRelatorios.master" AutoEventWireup="true" CodeBehind="wfmRelatorioSecoes.aspx.cs" Inherits="WEB.wfmRelatorioSecoes" %>
...
<dx:ASPxGridView ID="dGridResposta" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn VisibleIndex="5" 
            FieldName="Diretoria" Caption="Diretoria">
        </dx:GridViewDataTextColumn>

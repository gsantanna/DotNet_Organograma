<%@ Page Title="" Language="C#" MasterPageFile="~/gsOrgRelatorios.master" AutoEventWireup="true" CodeBehind="wfmRelatorioSecoesSuperiores.aspx.cs" Inherits="WEB.wfmRelatorioSecoesSuperiores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cpTitulo" runat="server">
    <p>Relatório de Seções Superiores</p>
...
<asp:View ID="vFiltro" runat="server" >
 <!-- Filtro -->
    ...
    <tr>
    <td><uc1:FiltroRelatoriosSecao ID="filtroMain" runat="server" 
            IncluirDiretorias="True" IncluirSecoes="True" SomenteSuperiores="True" /></td>
    </tr>
    ...
    <td style=" text-align:right;">  
     <dx:ASPxCheckBox ID="chkSubsecao" runat="server" Text="Incluir Subseções" />
...
<dx:ASPxGridView ID="dGridResposta" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="Seção Superior" FieldName="Secao" 
            VisibleIndex="1">
            <Settings AutoFilterCondition="Contains" />
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn VisibleIndex="4" FieldName="GestorEmail" 
            Caption="E-mail Gestor">
            <Settings AutoFilterCondition="Contains" />

        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="Secoes_Linha" VisibleIndex="7" 
            Caption="Seções">

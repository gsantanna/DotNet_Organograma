...
<%@ Page Title="" Language="C#" MasterPageFile="~/gsOrgMaster.Master" AutoEventWireup="true" CodeBehind="wfmSubsecaoAdd.aspx.cs" Inherits="WEB.wfmSubsecaoAdd" %>
<%@ MasterType VirtualPath="~/gsOrgMaster.Master" %>
                            ...
                            <ContentCollection>
                                <dx:SplitterContentControl runat="server" SupportsDisabledAttribute="True">
                                    <table style="width:100%;padding:0px 0px 10px 0px;">
                                        ...
                                        <tr>
                                            <td>
                                               <span class="TextoCinzaMedio">Gestor:</span>
                                        ...
                                        <tr>
                                            <td>
                                                <dx:ASPxComboBox ID="cboGestor" runat="server" Width="100%"
                                                IncrementalFilteringMode="Contains" 
                                                >
                                                </dx:ASPxComboBox>
                                            </td>

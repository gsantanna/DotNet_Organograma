...
<%@ Page Title="" Language="C#" MasterPageFile="~/gsOrgMaster.Master" AutoEventWireup="true" CodeBehind="wfmValidacao.aspx.cs" Inherits="WEB.wfmValidacao" %>
...
<div class="Subtitulo" style="width:98%!important;margin-right:0px!important;padding-right:0px !important;">

<div style="float:left">Validações</div>


   <div style="float:right;width:32px;"><dx:ASPxButton ID="btnPDF" runat="server" 
...
<Image Url="~/Imagens/pdf.png"></Image>
                        ...
                        <div style="float:right;width:32px;"><dx:ASPxButton ID="btnXLS" runat="server" 
                                EnableDefaultAppearance="false" Width="32px" Height="32px" 
